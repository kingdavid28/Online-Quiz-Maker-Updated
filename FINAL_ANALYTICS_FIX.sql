-- FINAL FIX FOR QUIZ ANALYTICS SECURITY DEFINER WARNING
...
DROP POLICY IF EXISTS "Users can view their own quiz analytics" ON public.quiz_attempts;
...
-- Recreate RLS policy for direct analytics access
